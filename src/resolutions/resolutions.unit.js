...
describe('resolve ssg resolutions', function () {
    test('v1 SSG id is rejected', async () => {
        ...
        body.errors.should.eql([{
            ...
            title: 'Compliance v1 issue identifiers have been retired. Please update your v1 issue ID, "rhel7|pci-dss|xccdf_org.ssgproject.content_rule_disable_prelink", to the v2 format of "ssg:xccdf_org.ssgproject.content_benchmark_RHEL-X|version|profile|xccdf_org.ssgproject.content_rule_disable_prelink"'
        }]);
    });
    ...
    test('v1 SSG id (uppercase profile) is rejected', async () => {
        ...
        body.errors.should.eql([{
            ...
            status: 400,
            code: 'INVALID_ISSUE_IDENTIFIER',
            title: 'Compliance v1 issue identifiers have been retired. Please update your v1 issue ID, "rhel7|C2S|xccdf_org.ssgproject.content_rule_disable_host_auth", to the v2 format of "ssg:xccdf_org.ssgproject.content_benchmark_RHEL-X|version|profile|xccdf_org.ssgproject.content_rule_disable_host_auth"'
        }]);
    });
